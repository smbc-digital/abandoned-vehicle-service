<h1 align="center">Abandoned vehicle service</h1>

<div align="center">
 :see_no_evil: :dizzy: :truck:
</div>
<div align="center">
  Dude, where's my car?
</div>
...
<div align="center">
  ...
  <img alt="Open Issues" src="https://img.shields.io/github/issues/smbc-digital/abandoned-vehicle-service">
    <img alt="Stars" src="https://img.shields.io/github/stars/smbc-digital/abandoned-vehicle-service">
...
## Installation
```console
$ git clone git@github.com:smbc-digital/abandoned-vehicle-service.git
$ abandoned-vehicle-service/src
$ git-crypt unlock
$ dotnet run
```
